...
from app.api.v2.answers.views import Answers, UpdateAnswer, AcceptAnswer
...
'/questions/<int:question_id>/questions')
API.add_resource(UpdateAnswer,
'/answers/<int:answer_id>/answers')
API.add_resource(AcceptAnswer,
